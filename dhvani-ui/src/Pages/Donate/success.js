...
const DonateSuccess = () => {
    ...
    const executePayment = () => {
        ...
        const donationInfo = localStorage.getItem('donation') ? JSON.parse(localStorage.getItem('donation')) : null
        ...
        const body = {
            ...
            payment: {
                transactionType: Constants.DONATION_TRANSACTION_TYPE_PAYPAL,
