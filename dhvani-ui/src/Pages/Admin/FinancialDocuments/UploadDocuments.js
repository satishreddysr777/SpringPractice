...
const UploadDocuments = ({ open, setOpen, getDocuments = () => {} }) => {
    const [uploadDocumentsResults, setUploadDocumentsResults] = useState({
        loading: false,
        error: false,
        message: "",
        data: null,
    ...
    const uploadDocuments = async () => {
        ...
        try {
            ...
            await ApiService.addFinancialDocuments(formData);
            setUploadDocumentsResults((prev) => ({
                ...prev,
                loading: false,
            }));
            setDocuments([])
                        ...
                        >
                            <Dialog.Panel className="relative transform overflow-hidden rounded-md bg-white text-left shadow-md transition-all sm:my-8 w-full sm:max-w-[40em] h-full">
                                        ...
                                        <form className="space-y-4 md:space-y-6">
                                            ...
                                            <div className="relative border-2 border-dashed border-gray-400 rounded-md p-6 !mt-0 flex flex-col justify-center items-center">
                                                <div className="text-gray-600">
                                                    <div className="mt-1 text-sm leading-normal" onDragOver={handleDragOver} onDrop={handleDrop}>
                                                        {documents.length ===
                                                            0 && (
                                                            <>
                                                                <label
                                ...
                                <div className="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                                    ...
                                    >
                                        {uploadDocumentsResults.loading && (
                                            <span>
                                                <svg
                                                    aria-hidden="true"
                                                    role="status"
