                  ...
                  <div className="space-y-6 bg-white px-4 py-5 sm:p-6">
                    ...
                    <div>
                      ...
                      <div className="mt-1 flex items-center">
                        ...
                        <button
                          type="button"
                          className="ml-5 rounded-md border border-gray-300 bg-white py-2 px-3 text-sm font-medium leading-4 text-gray-700 shadow-sm hover:bg-gray-50 focus:outline-none "
                        >
                          Change
                        </button>
                      </div>
