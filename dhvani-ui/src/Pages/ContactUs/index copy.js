                ...
                <div className="container mx-auto">
                    <div className="-mx-4 flex flex-wrap">
                        ...
                        <div className="w-full px-4 lg:w-1/2 xl:w-4/12">
                            ...
                            <div className="relative rounded-lg bg-white p-8 shadow border sm:p-12">
                                <form>
                                    <div className="mb-6">
                                        <TextField
                                            label="Name"
                                    ...
                                    <div>
                                        <button
                                            type="button"
                                            className="w-full text-white bg-green-500 hover:bg-green-600 font-medium rounded-md text-sm px-5 py-3 mr-2 mb-2  focus:outline-none"
