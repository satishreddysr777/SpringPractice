...
const ContactUs = () => {
    ...
    const addContact = async (values) => {
        try {
            ...
            let res = await ApiService.addContact(body);
            setLoading(false);
            ...
            <div className="container mx-auto px-5">
                <div className="-mx-4 flex flex-wrap">
                            ...
                            <div className="mb-8 flex w-full max-w-[370px]">
                                ...
                                <div className="w-full">
                                    ...
                                    <p className="text-body-color text-base">
                                        3910 Old Highway 94 S, STE 110 Saint
                                        Charles, MO – 63304, United States
                                    </p>
                                </div>
                            </div>
                            <div className="mb-8 flex w-full max-w-[370px]">
                    ...
                    <div className="w-full px-4 lg:w-1/2 xl:w-4/12">
                        <div className="relative rounded-lg bg-white p-8 md:shadow md:border sm:p-12">
                            <form>
                                <div className="mb-6">
                                    <TextField
                                        label="Name"
                                ...
                                <div>
                                    <button
                                        ...
                                        className={`bg-[#10a37f] w-full hover:opacity-90 text-[#fff] border-none rounded-md box-border cursor-pointer inline-flex font-normal justify-center leading-5 items-center position-relative transition duration-300 ease-in-out select-none focus:outline-none focus:shadow-outline-blue text-sm px-3 py-3`}
                                    >
                                        GET IN TOUCH
                                    </button>
                                </div>
